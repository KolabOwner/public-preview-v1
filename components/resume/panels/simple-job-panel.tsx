...
interface SimpleJobPanelProps {
  onComplete?: () => void;
  className?: string;
}

export default function SimpleJobPanel({ onComplete, className = '' }: SimpleJobPanelProps) {
  const { analyzeJob, isAnalyzing, error } = useSimpleJob();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: error || 'Unable to analyze job keywords',
        variant: 'destructive',
      });
    }
  };
