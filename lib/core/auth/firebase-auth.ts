// ==========================================
// 1. Fixed lib/core/auth/firebase-auth.ts
// ==========================================
...
// Session Management - FIXED FUNCTION SIGNATURE
export async function setPersistenceLevel(persistenceType: 'local' | 'session') {
  try {
